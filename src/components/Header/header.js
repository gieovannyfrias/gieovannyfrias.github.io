...
<i class="fas fa-angle-down angle-view-sub-menu" role="button" aria-expanded="false"></i>
         ...
         <li class="item-menu">
          <a href="https://www.cameo.com/gieovannyfrias" class="item-menu-link">Mis fans</a>
        </li>
         <li class="item-menu">
...
<i class="fas fa-angle-down angle-view-sub-menu" role="button" aria-expanded="false"></i>
 ...
 <li class="item-menu">
              <a href="/Citas" class="item-menu-link">Agendar cita</a>
                 ...
                 <li class="item-menu item-menu-sub-menu">
          <a href="#" class="item-menu-link">Crypto</a>
<i class="fas fa-angle-down angle-view-sub-menu" role="button" aria-expanded="false"></i>
  ...
  <li class="item-menu">
    <a href="/NFT" class="item-menu-link">NFT</a>
        ...
        <li class="item-menu item-menu-sub-menu">
          <a href="#" class="item-menu-link">Cc</a>
<i class="fas fa-angle-down angle-view-sub-menu" role="button" aria-expanded="false"></i>
...
<button class="btn-hamburguesa" id="btn-hamburguesa" aria-controls="menu-navegacion" aria-expanded="false">
      <span></span>
      <span></span>
      <span></span>
    </button>
...
.link-logo {
  ...
  color: white;
  font-size: 28px;
    background: linear-gradient(90deg, rgba(15, 23, 42, 0.85) 0%, rgba(255, 255, 255, 0.9) 100%);
...
/* ====== link de flechas de dezlisamiento ====== */
...
/* ====== Submenús desplegables con flechas ====== */
